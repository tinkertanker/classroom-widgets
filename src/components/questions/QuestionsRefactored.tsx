...
function QuestionsRefactored({ widgetId, savedState, onStateChange }: QuestionsProps) {
  ...
  return (
    <NetworkedWidgetWrapper
      ...
      headerChildren={
        <button
          onClick={() => {
            // Toggle will be implemented here
    ...
    >
      {({ session, isRoomActive }) => {
        ...
        const handleToggleActive = () => {
          ...
          const eventName = isActive ? eventNames.stop : eventNames.start;
...
export default QuestionsRefactored;