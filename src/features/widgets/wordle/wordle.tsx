...
const Wordle: React.FC<WordleProps> = ({ savedState, onStateChange }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-soft-white dark:bg-warm-gray-800 rounded-lg shadow-sm border border-warm-gray-200 dark:border-warm-gray-700">
      {/* Header */}
