...
export default class TypeBuilder {
    ...
    CommandParameters: ClassViewer<'CommandParameters', "duration" | "items" | "text" | "soundName" | "mode" | "state" | "options">;
    
    FeedbackMessage: ClassViewer<'FeedbackMessage', "message" | "type" | "shouldSpeak">;
    
    VoiceCommand: ClassViewer<'VoiceCommand', "action" | "target" | "confidence" | "parameters" | "feedback">;
    ...
    constructor() {
        this.tb = new _TypeBuilder({
          classes: new Set([
            "CommandParameters","FeedbackMessage","VoiceCommand",
          ]),
          enums: new Set([
        ...
        this.CommandParameters = this.tb.classViewer("CommandParameters", [
          "duration","items","text","soundName","mode","state","options",
        ]);
        
        this.FeedbackMessage = this.tb.classViewer("FeedbackMessage", [
          "message","type","shouldSpeak",
        ]);
        
        this.VoiceCommand = this.tb.classViewer("VoiceCommand", [
          "action","target","confidence","parameters","feedback",
        ]);
