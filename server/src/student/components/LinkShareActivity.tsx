      ...
      {!isActive ? (
        ...
        <>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={isSubmitting || !isActive} className="mt-3 w-full bg-transparent dark:bg-transparent border-2 border-terracotta-500 dark:border-terracotta-400 text-terracotta-600 dark:text-terracotta-400 hover:bg-terracotta-500 hover:text-white dark:hover:bg-terracotta-400 dark:hover:text-warm-gray-900 py-2 px-3 rounded-md text-sm font-medium cursor-pointer transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed">
