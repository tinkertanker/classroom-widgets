          ...
          <form onSubmit={handleSubmitQuestion} className="mb-4">
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full bg-sky-500 dark:bg-sky-400 text-white hover:bg-sky-600 dark:hover:bg-sky-500 py-2 px-3 rounded-md text-sm font-medium cursor-pointer transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
